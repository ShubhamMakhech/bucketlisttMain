...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        className="section-wrapper section-bg-primary SectionPaddingTop SectionPaddingBottom MaxWidthContainer"
        id="ExploreIndiaTopDestinations "
      >
        <div className="PaddingTopSet">
          {/* <BidirectionalAnimatedSection
              // animation="fade-up"
              // delay={100}
              // duration={600}
      ...
      <BidirectionalAnimatedSection
        ...
        duration={700}
      >
        <section className="section-wrapper SectionPaddingTop SectionPaddingBottom">
          <div className="MaxWidthContainer">
            ...
            >
              <div className="HeadingHeaderCommonUsed">
                <h2 className="CommonH2">Best-Sellers</h2>
