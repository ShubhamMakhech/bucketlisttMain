...
// Hero section with new visual design, preserving search functionality from the old Hero component.
            ...
            <div className="HeroHomeContentContainer">
                ...
                {backgroundImages.map((image, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`HeroBackgroundSliderItem ${isActive ? "active" : ""
                                } ${isExiting ? "exiting" : ""}`}
                        >
                    ...
                    <div>
                        <div>
                            ...
                            <p className="textAlignStart ColorWhite MarginTopSmall SecondaryColorText">
                                Curated with intention. Delivered with trust. Designed for
                                meaningful moments.
                            </p>
                                ...
                                {suggestions?.destinations &&
                                    suggestions.destinations.length > 0 && (
                                        <div>
                                            ...
                                            {suggestions.destinations.map((destination: any) => (
                                                <div
                                ...
                                {suggestions?.experiences &&
                                    suggestions.experiences.length > 0 && (
                                        <div>
                                            ...
                                            {suggestions.experiences.map((experience: any) => (
                                                <div
