                          ...
                          <div className="mb-4">
                            {activity.discounted_price && activity.discounted_price !== activity.price ? (
                              <div className="flex flex-col">
                                ...
                                <div className={`text-2xl font-bold ${selectedActivityId === activity.id ? 'text-green-600' : 'text-green-600'
                                  }`}>
                                  {activity.currency === "USD" ? "₹" : activity.currency === "INR" ? "₹" : activity.currency} {activity.discounted_price}
                                </div>
                              </div>
                            ) : (
                      ...
                      <div className="text-right">
                        {activity.discounted_price && activity.discounted_price !== activity.price ? (
                          <div className="flex flex-col items-end">
                            ...
                            <div className={`text-base font-bold ${isSelected ? 'text-green-600' : 'text-green-600'}`}>
                              {activity.currency === "USD" ? "₹" : activity.currency === "INR" ? "₹" : activity.currency} {activity.discounted_price}
                            </div>
                          </div>
                        ) : (
            ...
            <>
              <div className='CalenderLayoutContainer '>
                ...
                <div className="grid grid-cols-5 gap-1 pb-2 AdjustContainer">
                  {next4Days.map((date) => {
                    ...
                    return (
                      <div
                        ...
                        className={`cursor-pointer transition-all duration-200 ${isDisabled ? 'opacity-50 cursor-not-allowed' : 'hover:scale-105'
                          }`}
                  ...
                  >
                    <Button
                      className="w-full h-20 flex flex-col items-center justify-center gap-1 border-gray-200 hover:border-gray-300 p-1"
                    >
                      <CalendarIcon className="h-4 w-4 text-gray-600" />
                      <span className="font-medium text-gray-600">More <br />dates</span>
                    </Button>
                  </Popover>
                </div>
              </div>
