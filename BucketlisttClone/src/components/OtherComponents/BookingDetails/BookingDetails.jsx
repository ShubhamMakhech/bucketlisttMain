...
import { ArrowLeft, Plus, Tag, AlertCircle, Minus, ChevronDown, ChevronUp, Home, ChevronRight } from "lucide-react";
import { supabase } from "@/integrations/supabase/client";
import { useAuth } from "@/contexts/AuthContext";
import { useToast } from "@/hooks/use-toast";
import BookingSlotsCard from "./BookingSlotsCard/BookingSlotsCard";
...
export const BookingDetails = () => {
    ...
    // Get experience data from navigation state or fetch from URL
    ...
    const {
        ...
        enabled: !!name && !stateExperienceData,
        initialData: stateExperienceData?.url_name === name ? stateExperienceData : undefined,
    });
    ...
    const basePrice = (experience?.price || 0) * participantCount;
    ...
    const handleNextStep = () => {
        if (isMobile) {
            ...
            if (currentStep === 1) {
                ...
                // Step 2 -> Navigate to user information: Check if date and time slot are selected
                if (selectedDate && selectedSlotId) {
                    ...
                    // Navigate to user information route with state
                    navigate(`/booking/${name}/user-information`, {
                        state: {
            ...
            // Desktop: Navigate to user information
    ...
    const handleClose = () => {
        // Navigate back to the activity page
        if (name) {
    ...
    if (error || !experience) {
        return (
            <div className="booking-details-page">
                <div className="booking-details-container">
                    <div className="booking-error">Experience not found</div>
                </div>
            </div>
        );
    }
    ...
    if (experience.is_active === false) {
        return (
            <div className="booking-details-page">
                <div className="booking-details-container">
                    <div className="booking-error">This experience is not active.</div>
                </div>
            </div>
        );
    }
    ...
    const createDirectBooking = async (data) => {
                                    ...
                                    <Card className="py-2 px-2" id="BookingSummaryCard">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-gray-600 text-sm md:text-base">
                                                            {(() => {
                                                                ...
                                                                return slot ? `${formatTime(slot.start_time)}` : "Select Time Slot";
                                                            })()}
                                                        </span>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="text-right">
                                                {selectedActivity?.discounted_price &&
                                                    selectedActivity.discounted_price !==
    ...
    return (
        <div className="booking-details-page MaxWidthContainer ">
            <div className="booking-details-container SectionPaddingTop SectionPaddingBottom">
                {/* Breadcrumb */}
                <div className="booking-breadcrumb">
                    <button className="breadcrumb-back-button" onClick={handleCloseInternal}>
                        <ArrowLeft size={16} />
                    ...
                    <button className="breadcrumb-item" onClick={handleCloseInternal}>
