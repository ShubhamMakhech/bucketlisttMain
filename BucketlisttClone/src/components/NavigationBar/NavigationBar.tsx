...
export function NavigationBar() {
  ...
  }, [isLandingPage, location.pathname, maxScroll]);
  ...
  const getButtonStyles = () => {
    if (isLandingPage && containerHeight === 0)
  ...
  return (
    <>
      <header
        className={`navigation-bar sticky top-0 left-0 right-0 z-[9998] w-full transition-all duration-300 ${getHeaderStyles()}`}
      >
        <div
        ...
        <div className="navigation-content flex h-16 items-center justify-between px-4 max-w-7xl mx-auto relative">
          {/* Logo */}
          <Link
            to="/"
