...
export function SignInForm({
  ...
  const handleGoogleLogin = async () => {
    // Remember the exact URL (with query/hash) so we can return after OAuth
    localStorage.setItem("loggedInPath", window.location.href);
    ...
    try {
      ...
      // Explicitly follow the returned URL to avoid SPA intercept issues
      if (data?.url) {
